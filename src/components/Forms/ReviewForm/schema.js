...
const schema = yup.object().shape({
  firstName: yup.string().required(FIELD_REQUIRED).min(2, 'Name should have at least 2 characters'),
  lastName: yup.string().required(FIELD_REQUIRED).min(2, 'Last Name should have at least 2 characters'),
  age: yup
    .number()
